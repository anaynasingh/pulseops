    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: "Total Projects", value: stats?.total_projects ?? 0, icon: "◈", change: null },
            { label: "Active", value: stats?.active_projects ?? 0, icon: "▶", change: null },
            { label: "Blocked", value: stats?.blocked_projects ?? 0, icon: "⊗", change: null },
            { label: "Done This Week", value: stats?.done_this_week ?? 0, icon: "✓", change: null },
          ].map((kpi) => (
